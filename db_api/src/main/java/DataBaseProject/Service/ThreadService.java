...
public class ThreadService {
    ...
    public ResponseEntity<Object> createPosts (List<PostModel> posts, String slug_or_id) {
        try {
    ...
    public ResponseEntity<Object> viewThread (String slug_or_id) {
    ...
    public ResponseEntity<Object> updateThread (ThreadModel thread, String slug_or_id) {
        try {
    ...
    public ResponseEntity<Object> voteForThread (VoteModel vote, String slug_or_id) {
        final ThreadModel thread;
        try {
    ...
    public ResponseEntity<Object> getPostsSorted (String slug_or_id, Integer limit, Integer since, String sort, Boolean desc) {
        try {
            ThreadModel thread = threadFunctions.findByIdOrSlug(slug_or_id);
